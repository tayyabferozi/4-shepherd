    ...
    <div id="FAQ" className="">
      ...
      <div className="faqs">
        <div className="question">
          ...
          <p>
            We are the nexus between investors and players in the world "play to
            earn", we manage large amounts of players and income in
            cryptocurrencies in a safe and transparent way. Managing up to 10
            players can be an easy task, but when the numbers exceed 30 teams it
            becomes very difficult to keep track and manage rewards. That is why
            we specialize in generating tools to manage large flows of
            operations.
          </p>
        </div>
        <div className="question">
          ...
          <p>
            Everything related to cryptocurrencies is considered high risk, but
            having so good returns capital recovery times are much shorter than
            any other type of known investment.
          </p>
        </div>
        <div className="question">
        ...
        <div className="question">
          ...
          <p>
            We believe that these projects are in an initial stage, with a great
            future ahead that can change the way of seeing the world's
            ...
            GDP and they are already evaluating taxing those who gamble to earn
            money.
          </p>
        </div>
      </div>
